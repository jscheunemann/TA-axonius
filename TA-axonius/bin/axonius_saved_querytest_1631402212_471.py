...
import input_module_axonius_saved_querytest_1631402212_471 as input_module
...
class ModInputaxonius_saved_query(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("api_key", title="API Key",
                                         description="The API Key from https://axonius.example.com/account -> API Key",
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("api_secret", title="API Secret",
                                         description="The API Secret from https://axonius.example.com/account -> API Key",
                                         required_on_create=True,
                                         required_on_edit=False))
